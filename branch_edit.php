                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            $idcode = $_GET['id'];
                            include'connect.php';
                            $sql = "SELECT * FROM branch where branch_id='$idcode'";
                            ...
                            <form class="row g-3" action="branch_update.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="branch_boss"
                                        value="<?php echo $branch_boss;?>" required>
                                </div>
                                <div class="col-md-4">
